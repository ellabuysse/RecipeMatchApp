...
- (void)checkLikeStatusFromDraggableViewBackground:(DraggableView *_Nullable)nextCard withCompletion:(void (^_Nullable)(BOOL liked, NSError *_Nullable error))completion;
